...
CREATE UNIQUE INDEX shipping_rates_one_active_base_rate_uq
ON public.shipping_rates (shipping_zone_id)
WHERE is_active = true
  AND min_weight_grams IS NULL
  AND max_weight_grams IS NULL;

ALTER TABLE public.shipping_rates
ADD CONSTRAINT shipping_rates_fee_nonnegative_ck
CHECK (fee >= 0);

ALTER TABLE public.shipping_rates
ADD CONSTRAINT shipping_rates_min_weight_nonnegative_ck
CHECK (
...
ALTER TABLE public.shipping_rates
ADD CONSTRAINT shipping_rates_weight_bounds_ck
CHECK (
  max_weight_grams IS NULL
  OR min_weight_grams IS NULL
...
ADD CONSTRAINT homepage_sections_display_order_nonnegative_ck
CHECK (display_order >= 0);

ALTER TABLE public.search_query_logs
ADD CONSTRAINT search_query_logs_result_count_nonnegative_ck
CHECK (result_count >= 0);

ALTER TABLE public.inventory
ADD CONSTRAINT inventory_quantity_on_hand_nonnegative_ck
CHECK (quantity_on_hand >= 0);

ALTER TABLE public.stock_movements
ADD CONSTRAINT stock_movements_quantity_delta_nonzero_ck
CHECK (quantity_delta <> 0);

ALTER TABLE public.inventory_reservations
ADD CONSTRAINT inventory_reservations_quantity_positive_ck
CHECK (quantity > 0);

ALTER TABLE public.inventory_reservations
ADD CONSTRAINT inventory_reservations_expiry_after_creation_ck
CHECK (expires_at > created_at);

ALTER TABLE public.cart_items
ADD CONSTRAINT cart_items_quantity_positive_ck
CHECK (quantity > 0);

ALTER TABLE public.orders
ADD CONSTRAINT orders_subtotal_amount_nonnegative_ck
CHECK (subtotal_amount >= 0);

ALTER TABLE public.orders
ADD CONSTRAINT orders_discount_amount_nonnegative_ck
CHECK (discount_amount >= 0);

ALTER TABLE public.orders
ADD CONSTRAINT orders_shipping_fee_amount_nonnegative_ck
CHECK (shipping_fee_amount >= 0);

ALTER TABLE public.orders
ADD CONSTRAINT orders_total_amount_nonnegative_ck
CHECK (total_amount >= 0);

ALTER TABLE public.order_items
ADD CONSTRAINT order_items_quantity_positive_ck
CHECK (quantity > 0);

ALTER TABLE public.order_items
ADD CONSTRAINT order_items_unit_price_nonnegative_ck
CHECK (unit_price >= 0);

ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_discount_value_positive_ck
CHECK (discount_value > 0);

ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_max_discount_nonnegative_ck
CHECK (
...
ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_min_order_nonnegative_ck
CHECK (
...
ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_usage_limit_positive_ck
CHECK (
  usage_limit IS NULL
  OR usage_limit > 0
);
...
ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_per_user_limit_positive_ck
CHECK (
...
ALTER TABLE public.vouchers
ADD CONSTRAINT vouchers_valid_window_ck
CHECK (
  starts_at IS NULL
  OR ends_at IS NULL
...
ADD CONSTRAINT promotions_discount_value_positive_ck
CHECK (discount_value > 0);

ALTER TABLE public.promotions
ADD CONSTRAINT promotions_max_discount_nonnegative_ck
CHECK (
  max_discount_amount IS NULL
  OR max_discount_amount >= 0
);
...
ALTER TABLE public.promotions
ADD CONSTRAINT promotions_min_order_nonnegative_ck
CHECK (
  min_order_amount IS NULL
  OR min_order_amount >= 0
);
...
ALTER TABLE public.promotions
ADD CONSTRAINT promotions_valid_window_ck
CHECK (
  starts_at IS NULL
  OR ends_at IS NULL
  OR starts_at < ends_at
...
ADD CONSTRAINT voucher_usages_discount_nonnegative_ck
CHECK (discount_amount >= 0);

ALTER TABLE public.payments
ADD CONSTRAINT payments_amount_positive_ck
CHECK (amount > 0);

ALTER TABLE public.reviews
ADD CONSTRAINT reviews_rating_range_ck
CHECK (rating BETWEEN 1 AND 5);

ALTER TABLE public.review_media
ADD CONSTRAINT review_media_sort_order_nonnegative_ck
CHECK (sort_order >= 0);

ALTER TABLE public.return_items
ADD CONSTRAINT return_items_quantity_positive_ck
CHECK (quantity > 0);

ALTER TABLE public.return_items
ADD CONSTRAINT return_items_resolution_consistency_ck
CHECK (
  (
    resolution = 'REFUND'::public.return_item_resolution
    AND replacement_variant_id IS NULL
  )
  OR
  (
    resolution = 'EXCHANGE'::public.return_item_resolution
    AND replacement_variant_id IS NOT NULL
  )
);

ALTER TABLE public.refunds
ADD CONSTRAINT refunds_amount_positive_ck
CHECK (amount > 0);

ALTER TABLE public.refund_items
ADD CONSTRAINT refund_items_quantity_positive_ck
CHECK (quantity > 0);

ALTER TABLE public.refund_items
ADD CONSTRAINT refund_items_amount_positive_ck
CHECK (amount > 0);

ALTER TABLE staging.normalized_product_candidates
ADD CONSTRAINT normalized_product_candidates_price_nonnegative_ck
CHECK (
  price IS NULL
  OR price >= 0
);

ALTER TABLE reporting.daily_revenue
ADD CONSTRAINT daily_revenue_order_count_nonnegative_ck
CHECK (order_count >= 0);

ALTER TABLE reporting.daily_revenue
ADD CONSTRAINT daily_revenue_revenue_amount_nonnegative_ck
CHECK (revenue_amount >= 0);

ALTER TABLE reporting.top_selling_products
ADD CONSTRAINT top_selling_products_quantity_nonnegative_ck
CHECK (quantity_sold >= 0);

ALTER TABLE reporting.top_selling_products
ADD CONSTRAINT top_selling_products_revenue_nonnegative_ck
CHECK (revenue_amount >= 0);

ALTER TABLE reporting.orders_by_status
ADD CONSTRAINT orders_by_status_order_count_nonnegative_ck
CHECK (order_count >= 0);
